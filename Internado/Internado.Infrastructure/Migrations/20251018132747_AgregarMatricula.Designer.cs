...
namespace Internado.Infrastructure.Migrations
{
    ...
    [Migration("20251018132747_AgregarMatricula")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Internado.Infrastructure.Models.GradoCurso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GradoId", "CursoId")
                        .IsUnique();

                    b.ToTable("GradoCursos");
                });
            ...
            modelBuilder.Entity("Internado.Infrastructure.Models.GradoCurso", b =>
                {
                    b.HasOne("Internado.Infrastructure.Models.Curso", "Curso")
                        .WithMany("GradoCursos")
                        .HasForeignKey("CursoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_GradoCurso_Curso");

                    b.HasOne("Internado.Infrastructure.Models.Grado", "Grado")
                        .WithMany("GradoCursos")
